...
=======
=======
>>>>>>> 2e3f6be (fix merge conflitcs)
<<<<<<< HEAD A collection of user stories you can choose from. Stories inside
each priority level are not necessarily in order, it's up to your group to
decide how they fit into your strategy. These are also just suggestion, feel
free to change them or <<<<<<< HEAD create your own! ​
...
=======
> basic usability Homepage ======= create your own!
...
> > > > > > > # ae916f3 (update)
> > > > > > >
> > > > > > > ​ ​ A collection of user stories you can choose from. Stories
...
>>>>>>> ae916f3 (update)
=======
  <<<<<<< HEAD joining HYF as a volunteer.
=======
  <<<<<<< HEAD <<<<<<< HEAD joining HYF as a volunteer.
>>>>>>> f41ed85 (fix conflicts in backlog merge)
  ...
  - _There is a list to describe the advantages to become a volunteer at
    HYF._ > > > > > > > ae916f3 (update) ======= joining HYF as a volunteer. -
    _There is a list to describe the advantages to become a volunteer at HYF._
    ======= joining HYF as a volunteer.
